!
!===============================================================================
!-- Darcy flow - time dependent two-field formulation
!> Miniapp to solve time dependent two-field Darcy flow in parallel using PETSc
!===============================================================================
!/****p* programs|darcy_flow/darcy_2f
!* SYNOPSIS
PROGRAM darcy_2f_time
!* PURPOSE
!*   Miniapp to solve time dependent two-field Darcy flow in parallel using PETSc
!* ASSUMPTION
...
!===============================================================================
  ...
  !-- start MPI processes, PETSc and write miniapp details --
  CALL start_petsc_mpi();  CALL rootwrite_log(&
    'ParaGEMS: Solving two field Darcy flow in parallel using PETSc KSP')
  ...
  CALL setup_LHS_darcy(); CALL setup_RHS_darcy();  CALL setup_IC_BC_darcy()
